...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_typerase_error.dats: 1719(line=61, offs=1) -- 1883(line=68, offs=4)
*/
ATSstaticdec()
ats_ptr_type
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_typerase_error.dats: 1975(line=73, offs=22) -- 2089(line=76, offs=2)
*/
ATSglobaldec()
ats_void_type
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_2esats__the_trans4errlst_add (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp8) ;
...
__ats_lab__2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_2esats__the_trans4errlst_add:
...
return /* (tmp8) */ ;
} /* end of [_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_2esats__the_trans4errlst_add] */
...
/*
// /home/hwxi/Research/ATS-Postiats/src/pats_typerase_error.dats: 2162(line=80, offs=3) -- 2620(line=100, offs=2)
*/
ATSglobaldec()
ats_void_type
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_2esats__the_trans4errlst_finalize () {
/* local vardec */
// ATSlocal_void (tmp12) ;
...
__ats_lab__2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_2esats__the_trans4errlst_finalize:
...
if (tmp25) {
/* tmp24 = */ atspre_fprintf_exn (stderr, ATSstrcst("patsopt(TYPERASE): there are [%i] errors in total.\n"), tmp14) ;
} else {
/* empty */
} /* end of [if] */
tmp26 = atspre_igt (tmp14, 0) ;
if (tmp26) {
tmp27 = (ats_sum_ptr_type)(&_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_error_2esats__PATSOPT_TRANS4_EXN) ;
/* tmp12 = */ ats_raise_exn (tmp27) ;
} else {
/* empty */
} /* end of [if] */
return /* (tmp12) */ ;
} /* end of [_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_2esats__the_trans4errlst_finalize] */
...
ats_void_type
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__staload () {
static int _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__staload_flag = 0 ;
if (_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__staload_flag) return ;
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__staload_flag = 1 ;
...
extern ats_int_type _2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__dynload_flag ;

ats_void_type
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__dynload () {
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__dynload_flag = 1 ;
_2home_2hwxi_2Research_2ATS_2dPostiats_2src_2pats_typerase_error_2edats__staload () ;

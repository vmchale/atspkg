...
//
  ...
  if(!ATSCKpat_con1(arg0, 0)) {
    ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats/contrib/libatscc2js/ATS2-0.3.2/DATS/Bacon.js/baconjs_ext.dats: 3373(line=189, offs=11) -- 3392(line=189, offs=30)");
  } // ifnthen
  tmp26 = arg0[1];
...
//
  ...
  if(!ATSCKpat_con1(arg0, 0)) {
    ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats/contrib/libatscc2js/ATS2-0.3.2/DATS/Bacon.js/baconjs_ext.dats: 3581(line=200, offs=11) -- 3598(line=200, offs=28)");
  } // ifnthen
  tmp31 = arg0[1];
  tmp32 = [1, tmp31];
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      if(!ATSCKpat_con1(arg0, 0)) {
        ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats/contrib/libatscc2js/ATS2-0.3.2/DATS/Bacon.js/baconjs_ext.dats: 4529(line=254, offs=5) -- 4586(line=254, offs=62)");
      } // ifnthen
      ...
      while(true) {
        ...
        switch(tmplab) {
          ...
          if(ATSCKptrisnull(tmp60)) {
            ATSINScaseof_fail("/home/hwxi/Research/ATS-Postiats/contrib/libatscc2js/ATS2-0.3.2/DATS/Bacon.js/baconjs_ext.dats: 4560(line=254, offs=36) -- 4585(line=254, offs=61)");
          } // ifthen

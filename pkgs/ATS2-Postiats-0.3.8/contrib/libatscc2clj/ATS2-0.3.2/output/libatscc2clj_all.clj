...
;; The starting compilation time is: 2017-5-19:  7h:50m
;;
;;;;;;
...
;;
;;;;;;
(declare _ats2cljpre_list_vt_loop_3)
(declare _ats2cljpre_list_vt_aux_7)
(declare _ats2cljpre_list_vt_loop_10)
...
;;var tmplab,tmplab_clj
  ...
  (_ats2cljpre_list_vt_loop_3 arg0 0)
) ;; end-of-with-local-vars
) ;; end-of-fun
...
;;fun
(defn
 _ats2cljpre_list_vt_loop_3[arg0 arg1]
(
with-local-vars
[
;;knd = 1
...
;;var tmplab,tmplab_clj
  ...
  ;while(true){
   (loop [
    ...
    ;; __patsflab__ats2cljpre_list_vt_loop_3
    (let[
      casefnx
      (fn casefnx[tmplab](case tmplab
        ;; ATSbranchseq_beg
        ...
        4 (do
         ...
         ;; arg0 = apy0
         ;; arg1 = apy1
         ;; funlab_clj = 1; // __patsflab__ats2cljpre_list_vt_loop_3
         (_ats2cljpre_list_vt_loop_3 @tmp5 @tmp6)
        ) ;; end-of-branch
        ;; ATSbranchseq_end
        ;; (else (atscc2clj_caseof_deadcode _FILE_ _LINE_))
       ) ;; end-of-case
...
;;var tmplab,tmplab_clj
  ...
  (_ats2cljpre_list_vt_aux_7 arg0 arg1)
) ;; end-of-with-local-vars
) ;; end-of-fun
...
;;var tmplab,tmplab_clj
  ...
  ;; __patsflab__ats2cljpre_list_vt_aux_7
  (let[
    casefnx
    (fn casefnx[tmplab](case tmplab
      ;; ATSbranchseq_beg
      ...
      4 (do
       ...
       ;; ATSINSfreecon(arg0);
       (ATSINStmpset tmp17 (_ats2cljpre_list_vt_aux_7 @tmp16 arg1))
...
;;var tmplab,tmplab_clj
  ...
  (_ats2cljpre_list_vt_loop_10 arg0 arg1)
) ;; end-of-with-local-vars
) ;; end-of-fun
...
;;var tmplab,tmplab_clj
  ...
  ;while(true){
   (loop [
    ...
    ;; __patsflab__ats2cljpre_list_vt_loop_10
    (let[
      casefnx
      (fn casefnx[tmplab](case tmplab
        ;; ATSbranchseq_beg
        ...
        4 (do
         ...
         ;; arg0 = apy0
         ;; arg1 = apy1
         ;; funlab_clj = 1; // __patsflab__ats2cljpre_list_vt_loop_10
         (_ats2cljpre_list_vt_loop_10 @tmp23 @tmp24)
        ) ;; end-of-branch
        ;; ATSbranchseq_end
        ;; (else (atscc2clj_caseof_deadcode _FILE_ _LINE_))
       ) ;; end-of-case

...
in
let Lib = { name : Text, src : List Text, libTarget : Text, libs : List Text, includes : List Text, hsDeps : List ForeignCabal, hs2ats : List TargetPair, cSources : List Text, extras : List Text }
in
